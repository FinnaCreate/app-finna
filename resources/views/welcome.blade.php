...
<head>
    ...
    <!-- All Tailwind Styles Unpurged (17.4mb) - for easy browser development -->
    @env('local')
    <link rel="stylesheet" href="/tailwind-unpurged.css">
    @endenv
...
<body class="antialiased">
    <div
         class="flex relative justify-center py-4 min-h-screen bg-gray-100 items-top dark:bg-gray-900 sm:items-center sm:pt-0">
        @if (Route::has('login'))
            ...
            <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                <div class="text-sm text-center text-gray-500 sm:text-left">
                    <div class="flex items-center">
                        ...
                        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                             stroke-width="2" viewBox="0 0 24 24" class="-mt-px ml-4 w-5 h-5 text-gray-400">
                            <path
